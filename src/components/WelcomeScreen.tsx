...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onStart }) => {
  ...
  return (
    <div className="flex flex-col h-[100dvh] w-full relative overflow-hidden flex-shrink-0 flex-grow-0">
      ...
      <div className="absolute top-1 left-1/2 -translate-x-1/2 z-30 bg-[rgba(30,30,40,0.8)] backdrop-blur-md px-5 py-2 rounded-xl shadow-lg border border-white/10">
